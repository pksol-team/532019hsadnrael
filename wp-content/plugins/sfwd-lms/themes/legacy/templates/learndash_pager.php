...
if ( ( isset( $pager_results ) ) && ( !empty( $pager_results ) ) ) {
	...
	if ( $pager_results['total_pages'] > 1 ) {
		...
		<span class="pager-right">
			...
			<?php } ?>	data-paged="<?php echo $href_val_prefix . $next_page_number; ?>" class="<?php echo $pager_right_class ?>" <?php echo $pager_right_disabled; ?> title="<?php esc_attr_e( 'Next Page', 'leardnash' ); ?>">&rsaquo;</a>
