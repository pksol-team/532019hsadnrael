                    ...
                    <div class="ld-progress-steps">
                        ...
                        if ( $context === 'course' || $context === 'focus' ):
                            ...
                            if( $course_activity && get_post_type() === 'sfwd-courses' ):
                                echo sprintf( esc_html_x( 'Last activity on %s', 'Last activity date in infobar', 'learndash' ), date( get_option('date_format') ), $course_activity->activity_updated );
                            else:
                                echo sprintf( esc_html( '%s/%s Steps', 'learndash' ), $progress['completed'], $progress['total'] );
                            endif;
                        endif;
                        ?>
                    </div>
