	...
	<div class="ld-onboarding-more-help">
		<div class="ld-onboarding-row">
			<div class="ld-onboarding-col">
				...
				<ul>
					<li><a href="https://www.learndash.com/support/docs/tutorials/creating-your-first-course/" target="_blank" rel="noopener noreferrer">Creating Your First Course [Tutorial]</a></li>
