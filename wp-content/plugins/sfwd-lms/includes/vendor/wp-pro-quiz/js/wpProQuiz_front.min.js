				...
				success: function (response) {
					...
					$('.wpProQuiz_certificate a').each((index, element) => {
						...
						if(index == 0) {
							...
							$step2 += `
								<br>
								<a class="btn-blue download" target="_blank" href="`+ $href + `" title="Credencial" >Print your Credencial</a>
							`;
							...
							$step2 += `
								<br>
								<br>
								<a class="btn-blue download" target="_blank" href="`+ $href + `" title="Certificado">Print your Certificado</a>
							`;
							...
							$step2 += `
								<br>
								<br>
								<a class="btn-blue download" target="_blank" href="`+ $href + `" title="Diploma">Print your Diploma</a>
							`;
					...
					// <a class="btn-blue email_all" href="#">Pay for home delivery</a>

					$step2 += ` </div>
								<div><br>
								<br>
								<a class="btn-blue download_all" href="#">Download all documents</a>
								<br>
								<br>
								<br>
								<br>
								<small>(Includes watermark, diploma paper, laminated credential corresponding stamps and shipping within a maximum of 5 working days by Chilexpress)</small>
								</div>`;
