	...
	class LearnDash_Settings_Metabox_Course_Display_Content extends LearnDash_Settings_Metabox {
		...
		public function load_settings_values() {
			...
			if ( true === $this->settings_values_loaded ) {
				...
				if ( ! isset( $this->setting_option_values['course_lesson_per_page_custom'] ) ) {
					$this->setting_option_values['course_lesson_per_page_custom'] = '';
				}
				if ( empty( $this->setting_option_values['course_lesson_per_page_custom'] ) ) {
				...
				if ( ! isset( $this->setting_option_values['course_topic_per_page_custom'] ) ) {
					$this->setting_option_values['course_topic_per_page_custom'] = '';
				}
				if ( empty( $this->setting_option_values['course_topic_per_page_custom'] ) ) {
