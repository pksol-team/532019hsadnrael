		...
		*/
		...
		public function load_settings_values() {
			...
			if ( true === $this->settings_values_loaded ) {
				...
				if ( $this->quiz_edit ) {
					$this->setting_option_values['startOnlyRegisteredUser'] = $this->quiz_edit->isStartOnlyRegisteredUser();
					...
					$this->setting_option_values['prerequisiteList'] = $prerequisite_mapper->fetchQuizIds( $this->quiz_edit->getId() );
				}
			}
		...
		public function load_settings_fields() {
			...
			if ( ! empty( $prerequisite_quizzes ) ) {
				foreach ( $prerequisite_quizzes as $quiz_set ) {
					if ( absint( $quiz_set['id'] ) !== absint( $this->quiz_edit->getId() ) ) {
