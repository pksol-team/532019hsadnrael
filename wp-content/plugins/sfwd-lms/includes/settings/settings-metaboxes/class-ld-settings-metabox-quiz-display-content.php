		...
		public function load_settings_values() {
			...
			if ( true === $this->settings_values_loaded ) {
				...
				if ( $this->quiz_edit ) {
					...
					$this->setting_option_values['autostart'] = $this->quiz_edit->isAutostart();
					...
					$this->setting_option_values['showReviewQuestion'] = $this->quiz_edit->isShowReviewQuestion();
					...
					$this->setting_option_values['quizSummaryHide'] = $this->quiz_edit->isQuizSummaryHide();
					...
					$this->setting_option_values['skipQuestionDisabled'] = $this->quiz_edit->isSkipQuestionDisabled();
					...
					$this->setting_option_values['sortCategories'] = $this->quiz_edit->isSortCategories();
					...
					$this->setting_option_values['questionRandom'] = $this->quiz_edit->isQuestionRandom();
					...
					$this->setting_option_values['showMaxQuestion'] = $this->quiz_edit->isShowMaxQuestion();
					...
					$this->setting_option_values['showMaxQuestionValue'] = $this->quiz_edit->getShowMaxQuestionValue();
					...
					$this->setting_option_values['showPoints'] = $this->quiz_edit->isShowPoints();
					if ( true === $this->quiz_edit->isShowPoints() ) {
						$this->setting_option_values['showPoints'] = 'on';
					} else {
						$this->setting_option_values['showPoints'] = '';
					}

					$this->setting_option_values['showCategory'] = $this->quiz_edit->isShowCategory();
					...
					$this->setting_option_values['hideQuestionPositionOverview'] = $this->quiz_edit->isHideQuestionPositionOverview();
					...
					$this->setting_option_values['hideQuestionNumbering'] = $this->quiz_edit->isHideQuestionNumbering();
					...
					$this->setting_option_values['numberedAnswer'] = $this->quiz_edit->isNumberedAnswer();
					...
					$this->setting_option_values['answerRandom'] = $this->quiz_edit->isAnswerRandom();
					...
					$this->setting_option_values['quizModus'] = (int) $this->quiz_edit->getQuizModus();
					if ( 0 === $this->setting_option_values['quizModus'] ) {
						...
						$this->setting_option_values['quizModus_multiple_questionsPerPage'] = (int) $this->quiz_edit->getQuestionsPerPage();
					}

					$this->setting_option_values['titleHidden'] = $this->quiz_edit->isTitleHidden();
			...
			$this->setting_option_fields = array(
				'quizModus_single_feedback' => array(
					...
					'options'    => array(
						...
						'each' => array(
							'label' => 'Display results after each submitted answer',
						),
					),
				),
			);
