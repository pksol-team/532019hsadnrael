			...
			$this->setting_option_fields = array(
				...
				'lesson_video_enabled'               => array(
					...
					'help_text'           => sprintf(
						...
						esc_html_x( 'Require users to watch the full video as part of the %s progression. Use shortcode [ld_video] to move within the post content.', 'learndash' ),
				...
				'lesson_video_auto_start'            => array(
					...
					'default'        => '',
					'options'        => array(
						'on' => 'The video now starts automatically on page load',
						''   => '',
					),
					'parent_setting' => 'lesson_video_enabled',
				),
