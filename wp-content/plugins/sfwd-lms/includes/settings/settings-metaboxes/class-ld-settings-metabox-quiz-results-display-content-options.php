	...
	class LearnDash_Settings_Metabox_Quiz_Results_Options extends LearnDash_Settings_Metabox {
		...
		public function load_settings_values() {
			...
			if ( true === $this->settings_values_loaded ) {
				...
				if ( $this->quiz_edit ) {
					$this->setting_option_values['resultGradeEnabled'] = $this->quiz_edit->isResultGradeEnabled();
					...
					$this->setting_option_values['btnRestartQuizHidden'] = $this->quiz_edit->isBtnRestartQuizHidden();
					...
					$this->setting_option_values['showAverageResult'] = $this->quiz_edit->isShowAverageResult();
					...
					$this->setting_option_values['showCategoryScore'] = $this->quiz_edit->isShowCategoryScore();
					...
					$this->setting_option_values['hideResultPoints'] = $this->quiz_edit->isHideResultPoints();
					...
					$this->setting_option_values['hideResultCorrectQuestion'] = $this->quiz_edit->isHideResultCorrectQuestion();
					...
					$this->setting_option_values['hideResultQuizTime'] = $this->quiz_edit->isHideResultQuizTime();
					...
					$this->setting_option_values['hideAnswerMessageBox'] = $this->quiz_edit->isHideAnswerMessageBox();
					...
					$this->setting_option_values['disabledAnswerMark'] = $this->quiz_edit->isDisabledAnswerMark();
					...
					$this->setting_option_values['btnViewQuestionHidden'] = $this->quiz_edit->isBtnViewQuestionHidden();
					...
					$this->setting_option_values['resultText']      = $this->quiz_edit->getResultText();
					if ( ! empty( $this->setting_option_values['resultText'] ) ) {
						$this->setting_option_values['quiz_result_messages'] = 'on';
						...
						$this->setting_option_values['quiz_result_messages'] = '';
					}
				}
			}
		...
		public function load_settings_fields() {
			...
			$this->setting_option_fields = array(
				'quiz_result_messages'       => array(
					'name'                => 'quiz_result_messages',
					'type'                => 'checkbox-switch',
					'label'               => esc_html__( 'Result Message(s)', 'learndash' ),
					'value'               => $this->setting_option_values['quiz_result_messages'],
					'default'             => '',
					...
					'child_section_state' => ( 'on' === $this->setting_option_values['quiz_result_messages'] ) ? 'open' : 'closed',
				),
				...
				'resultText'                 => array(
					...
					'label_none'     => true,
					'input_full'     => true,
					'parent_setting' => 'quiz_result_messages',
		...
		public function filter_saved_fields( $settings_values = array(), $settings_metabox_key = '', $settings_screen_id = '' ) {
			if ( ( $settings_screen_id === $this->settings_screen_id ) && ( $settings_metabox_key === $this->settings_metabox_key ) ) {
				...
				if ( ! isset( $settings_values['quiz_result_messages'] ) ) {
					$settings_values['quiz_result_messages'] = '';
				}
