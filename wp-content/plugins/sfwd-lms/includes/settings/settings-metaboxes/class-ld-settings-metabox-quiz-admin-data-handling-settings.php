	...
	class LearnDash_Settings_Metabox_Quiz_Admin_Data_Handling_Settings extends LearnDash_Settings_Metabox {
		...
		public function load_settings_values() {
			...
			if ( true === $this->settings_values_loaded ) {
				...
				$this->setting_option_values['formActivated'] = $this->quiz_edit->isFormActivated();
				...
				$this->setting_option_values['custom_fields_forms'] = $form_mapper->fetch( $this->quiz_edit->getId() );
				...
				$this->setting_option_values['formShowPosition'] = $this->quiz_edit->getFormShowPosition();
				...
				$this->setting_option_values['toplistActivated'] = $this->quiz_edit->isToplistActivated();
				...
				$this->setting_option_values['toplistDataAddPermissions'] = $this->quiz_edit->getToplistDataAddPermissions();
				$this->setting_option_values['toplistDataAddMultiple']    = $this->quiz_edit->isToplistDataAddMultiple();
				if ( true === $this->setting_option_values['toplistDataAddMultiple'] ) {
					$this->setting_option_values['toplistDataAddMultiple'] = 'on';
				}

				$this->setting_option_values['toplistDataAddBlock']     = absint( $this->quiz_edit->getToplistDataAddBlock() );
				$this->setting_option_values['toplistDataAddAutomatic'] = $this->quiz_edit->isToplistDataAddAutomatic();
				...
				$this->setting_option_values['toplistDataShowLimit'] = $this->quiz_edit->getToplistDataShowLimit();
				$this->setting_option_values['toplistDataSort']      = $this->quiz_edit->getToplistDataSort();
				$this->setting_option_values['toplistDataShowIn']    = $this->quiz_edit->getToplistDataShowIn();
				...
				if ( class_exists( 'ReallySimpleCaptcha' ) ) {
					$this->setting_option_values['toplistDataCaptcha'] = $this->quiz_edit->isToplistDataCaptcha();
				...
				$this->setting_option_values['statisticsOn'] = $this->quiz_edit->isStatisticsOn();
				...
				$this->setting_option_values['viewProfileStatistics'] = $this->quiz_edit->getViewProfileStatistics();
				...
				$this->setting_option_values['statisticsIpLock'] = $this->quiz_edit->getStatisticsIpLock();
				...
				$this->setting_option_values['emailNotification'] = $this->quiz_edit->getEmailNotification();
				...
				$this->setting_option_values['userEmailNotification'] = $this->quiz_edit->isUserEmailNotification();
				...
				$this->setting_option_values['timeLimitCookie'] = $this->quiz_edit->getTimeLimitCookie();
			...
			if ( ( isset( $_GET['templateLoadId'] ) ) && ( ! empty( $_GET['templateLoadId'] ) ) ) {
				$this->setting_option_values['templates_enabled'] = absint( $_GET['templateLoadId'] );
			}
			if ( ! empty( $this->setting_option_values['templates_enabled'] ) ) {
		...
		public function filter_saved_fields( $settings_values = array(), $settings_metabox_key = '', $settings_screen_id = '' ) {
			if ( ( $settings_screen_id === $this->settings_screen_id ) && ( $settings_metabox_key === $this->settings_metabox_key ) ) {
				...
				if ( true !== $settings_values['formActivated'] ) {
					$settings_values['toplistDataAddMultiple'] = false;
					$settings_values['toplistDataAddAutomatic'] = false;
					$settings_values['toplistDataShowIn'] = 0;
					$settings_values['toplistDataCaptcha'] = false;
