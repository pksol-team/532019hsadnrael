...
class ITSEC_Two_Factor_On_Board {
	...
	public function force_completion( $user ) {
		$reason = $this->two_factor->get_two_factor_requirement_reason( $user->ID );
	...
	public function render( $user ) {
		...
		wp_enqueue_script( 'itsec-2fa-on-board', plugin_dir_url( __FILE__ ) . 'js/on-board.js', array( 'jquery', 'wp-backbone', 'underscore', 'wp-a11y' ), 4 );
