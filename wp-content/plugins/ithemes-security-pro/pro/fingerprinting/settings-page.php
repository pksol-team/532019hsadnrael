...
class ITSEC_Fingerprinting_Settings_Page extends ITSEC_Module_Settings_Page {
	...
	protected function render_settings( $form ) {
		...
		<p><?php printf(
				esc_html__( 'Click the button below to automatically download the database or %1$smanually download it%2$s and upload the entire zip\'s contents to the following directory via (S)FTP: %3$s', 'it-l10n-ithemes-security-pro' ),
		...
		<p id="itsec-fingerprinting-maxmind-db-download-container" class="<?php $has_db and print( 'itsec-fingerprinting-maxmind-db-downloaded' ); ?>">
			...
			<span class="description itsec-fingerprinting-maxmind-db-download-warning-message">
				<?php esc_html_e( 'The download may take a few moments.', 'it-l10n-ithemes-security-pro' ); ?>
			</span>
		</p>
