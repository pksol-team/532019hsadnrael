 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Filter_Word_SeparatorToSeparator extends UcdZend_Filter_PregReplace
{
    ...
    protected function _separatorToSeparatorFilter($value)
    {
        if ($this->_searchSeparator == null) {
            ...
            throw new UcdZend_Filter_Exception('You must provide a search separator for this filter to work.');
        }
