 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Filter_HtmlEntities implements UcdZend_Filter_Interface
{
    /**
     ...
     * @return UcdZend_Filter_HtmlEntities Provides a fluent interface
     */
     ...
     *
     * @param  string $value
     * @return UcdZend_Filter_HtmlEntities
     */
