 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Filter_StringTrim implements UcdZend_Filter_Interface
{
    /**
     ...
     * Sets filter options
     *
     * @param  string|array|UcdZend_Config $charList
     * @return void
     */
    public function __construct($charList = null)
    {
        if ($charList instanceof UcdZend_Config) {
     ...
     * @return UcdZend_Filter_StringTrim Provides a fluent interface
     */
