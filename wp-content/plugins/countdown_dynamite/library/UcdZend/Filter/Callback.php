 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Filter_Callback implements UcdZend_Filter_Interface
{
    /**
    ...
    public function __construct($options)
    {
        ...
        if (!array_key_exists('callback', $options)) {
            ...
            throw new UcdZend_Filter_Exception('Missing callback to use');
        }
     ...
     * @return UcdZend_Filter_Callback
     */
