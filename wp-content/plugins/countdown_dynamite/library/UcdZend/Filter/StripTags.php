 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Filter_StripTags implements UcdZend_Filter_Interface
{
    /**
     * Unique ID prefix used for allowing comments
     */
    const UNIQUE_ID_PREFIX = '__UcdZend_Filter_StripTags__';
     ...
     * @return UcdZend_Filter_StripTags Provides a fluent interface
     */
