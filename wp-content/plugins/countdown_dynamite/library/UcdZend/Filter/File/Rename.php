 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Filter_File_Rename implements UcdZend_Filter_Interface
{
    /**
     ...
     * Class constructor
     *
     * Options argument may be either a string, a UcdZend_Config object, or an array.
     * If an array or UcdZend_Config object, it accepts the following keys:
     ...
     * @return UcdZend_Filter_File_Rename
     */
    ...
    public function addFile($options)
    {
        if (is_string($options)) {
            ...
            require_once 'UcdZend/Filter/Exception.php';
            throw new UcdZend_Filter_Exception ('Invalid options to rename filter provided');
        }
    ...
    public function getNewName($value, $source = false)
    {
        ...
        if (file_exists($file['target'])) {
            require_once 'UcdZend/Filter/Exception.php';
            throw new UcdZend_Filter_Exception(sprintf("File '%s' could not be renamed. It already exists.", $value));
        }
    ...
    public function filter($value)
    {
        ...
        require_once 'UcdZend/Filter/Exception.php';
        throw new UcdZend_Filter_Exception(sprintf("File '%s' could not be renamed. An error occurred while processing the file.", $value));
    }
