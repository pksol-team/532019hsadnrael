...
/**
 * @see UcdZend_Filter_Decrypt
 */
require_once 'UcdZend/Filter/Decrypt.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Filter_File_Decrypt extends UcdZend_Filter_Decrypt
{
    /**
     * New filename to set
     *
     ...
     * @return UcdZend_Filter_File_Encryt
     */
    ...
    public function filter($value)
    {
        ...
        if (file_exists($this->_filename) and !is_writable($this->_filename)) {
            require_once 'UcdZend/Filter/Exception.php';
            throw new UcdZend_Filter_Exception("File '{$this->_filename}' is not writable");
        }
        ...
        if (!$result) {
            require_once 'UcdZend/Filter/Exception.php';
            throw new UcdZend_Filter_Exception("Problem while writing file '{$this->_filename}'");
        }
