 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Filter_RealPath implements UcdZend_Filter_Interface
{
    /**
     ...
     * Class constructor
     *
     * @param boolean|UcdZend_Config $options Options to set
     */
     ...
     *
     * @param boolean|UcdZend_Config $exists Path must exist
     * @return UcdZend_Filter_RealPath
     */
    public function setExists($exists)
    {
        if ($exists instanceof UcdZend_Config) {
