 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Filter_PregReplace implements UcdZend_Filter_Interface
{
    /**
     * Pattern to match
     * @var mixed
     ...
     * @return UcdZend_Filter_PregReplace
     */
    ...
    public function filter($value)
    {
        if ($this->_matchPattern == null) {
            ...
            throw new UcdZend_Filter_Exception(get_class($this) . ' does not have a valid MatchPattern set.');
        }
