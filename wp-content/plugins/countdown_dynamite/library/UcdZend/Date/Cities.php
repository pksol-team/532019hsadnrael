 ...
 * @category   Zend
 * @package    UcdZend_Date
 * @subpackage UcdZend_Date_Cities
 * @copyright  Copyright (c) 2005-2012 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Date_Cities
{
    /**
     ...
     * @return array
     * @throws UcdZend_Date_Exception When city is unknown
     */
    public static function City($city, $horizon = false)
    {
        ...
        throw new UcdZend_Date_Exception('unknown city');
    }
