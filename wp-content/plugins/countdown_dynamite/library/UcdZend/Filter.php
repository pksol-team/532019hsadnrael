 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Filter implements UcdZend_Filter_Interface
{
     ...
     *
     * @param  UcdZend_Filter_Interface $filter
     * @param  string $placement
     * @return UcdZend_Filter Provides a fluent interface
     */
    public function addFilter(UcdZend_Filter_Interface $filter, $placement = self::CHAIN_APPEND)
    {
     ...
     * @return UcdZend_Filter Provides a fluent interface
     */
    public function appendFilter(UcdZend_Filter_Interface $filter)
    {
     ...
     * @return UcdZend_Filter Provides a fluent interface
     */
    public function prependFilter(UcdZend_Filter_Interface $filter)
    {
    ...
    /**
     * @deprecated
     * @see UcdZend_Filter::filterStatic()
     *
     * @param  mixed        $value
    ...
    {
        trigger_error(
            'UcdZend_Filter::get() is deprecated as of 1.9.0; please update your code to utilize UcdZend_Filter::filterStatic()',
            E_USER_NOTICE
        );
     ...
     * relative to the UcdZend_Filter namespace. This method automatically loads the class,
    ...
    public static function filterStatic($value, $classBaseName, array $args = array(), $namespaces = array())
    {
        ...
        $namespaces = array_merge((array) $namespaces, self::$_defaultNamespaces, array('UcdZend_Filter'));
        foreach ($namespaces as $namespace) {
            ...
            if (!class_exists($className, false)) {
                ...
                } catch (UcdZend_Exception $ze) {
                    continue;
                }
            }

            $class = new ReflectionClass($className);
            if ($class->implementsInterface('UcdZend_Filter_Interface')) {
        ...
        throw new UcdZend_Filter_Exception("Filter class not found from basename '$classBaseName'");
    }
}
