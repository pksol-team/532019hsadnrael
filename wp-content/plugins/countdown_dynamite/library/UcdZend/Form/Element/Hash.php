 ...
 */
class UcdZend_Form_Element_Hash extends UcdZend_Form_Element_Xhtml
{
    /**
     ...
     * Set session object
     *
     * @param  UcdZend_Session_Namespace $session
     * @return UcdZend_Form_Element_Hash
     */
     ...
     *
     * @return UcdZend_Session_Namespace
     */
    public function getSession()
    {
        if (null === $this->_session) {
            require_once 'UcdZend/Session/Namespace.php';
            $this->_session = new UcdZend_Session_Namespace($this->getSessionName());
        }
