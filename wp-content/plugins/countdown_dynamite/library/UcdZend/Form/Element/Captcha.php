...
/** @see UcdZend_Form_Element_Xhtml */
require_once 'UcdZend/Form/Element/Xhtml.php';

/** @see UcdZend_Captcha_Adapter */
require_once 'UcdZend/Captcha/Adapter.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Form_Element_Captcha extends UcdZend_Form_Element_Xhtml
{
    /**
     ...
     * Get captcha adapter
     *
     * @return UcdZend_Captcha_Adapter
     */
     ...
     * Set captcha adapter
     *
     * @param string|array|UcdZend_Captcha_Adapter $captcha
     * @param array $options
     */
    public function setCaptcha($captcha, $options = array())
    {
        if ($captcha instanceof UcdZend_Captcha_Adapter) {
            $instance = $captcha;
        } else {
            if (is_array($captcha)) {
     ...
     *
     * @param  array $options
     * @return UcdZend_Form_Element_Captcha
     */
        ...
        if ($type == self::CAPTCHA) {
            if (!isset($this->_loaders[$type])) {
                ...
                $this->_loaders[$type] = new UcdZend_Loader_PluginLoader(
                    array('UcdZend_Captcha' => 'UcdZend/Captcha/')
                );
            }
     ...
     * @see UcdZend_Form_Element::addPrefixPath
     */
