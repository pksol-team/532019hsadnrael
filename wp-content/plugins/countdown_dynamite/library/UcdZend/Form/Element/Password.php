 ...
 */
class UcdZend_Form_Element_Password extends UcdZend_Form_Element_Xhtml
{
    /**
     ...
     * @param  bool $flag
     * @return UcdZend_Form_Element_Password
     */
    ...
    public function isValid($value, $context = null)
    {
        foreach ($this->getValidators() as $validator) {
            if ($validator instanceof UcdZend_Validate_Abstract) {
