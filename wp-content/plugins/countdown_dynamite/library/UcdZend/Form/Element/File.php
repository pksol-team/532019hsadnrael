...
/** UcdZend_Form_Element_Xhtml */
require_once 'UcdZend/Form/Element/Xhtml.php';
 ...
 */
class UcdZend_Form_Element_File extends UcdZend_Form_Element_Xhtml
{
    /**
     * Plugin loader type
     */
    ...
    /**
     * @var UcdZend_File_Transfer_Adapter_Abstract
     */
    protected $_adapter;
     ...
     * @param  string $type
     * @return UcdZend_Form_Element_File
     */
    ...
    public function getPluginLoader($type)
    {
        ...
        if (!array_key_exists($type, $this->_loaders)) {
            ...
            $loader = new UcdZend_Loader_PluginLoader(array(
                'UcdZend_File_Transfer_Adapter' => 'UcdZend/File/Transfer/Adapter/',
            ));
     ...
     *
     * @param  string|UcdZend_File_Transfer_Adapter_Abstract $adapter
     * @return UcdZend_Form_Element_File
     */
    public function setTransferAdapter($adapter)
    {
        if ($adapter instanceof UcdZend_File_Transfer_Adapter_Abstract) {
            ...
            throw new UcdZend_Form_Element_Exception('Invalid adapter specified');
        }
     ...
     * @return UcdZend_Form_Element_File Provides fluent interface
     */
    ...
    public function render(UcdZend_View_Interface $view = null)
    {
        ...
        foreach ($this->getDecorators() as $decorator) {
            if ($decorator instanceof UcdZend_Form_Decorator_Marker_File_Interface) {
                $marker = true;
            }
        }
        ...
        if (!$marker) {
            require_once 'UcdZend/Form/Element/Exception.php';
            throw new UcdZend_Form_Element_Exception('No file decorator found... unable to render file element');
        }
