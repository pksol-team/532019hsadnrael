...
/**
 * UcdZend_Form_Decorator_FormErrors
 *
 ...
 */
class UcdZend_Form_Decorator_FormErrors extends UcdZend_Form_Decorator_Abstract
{
    /**
     ...
     * @return UcdZend_Form_Decorator_FormErrors
     */
     ...
     * @return string
     */
    public function renderLabel(UcdZend_Form_Element $element, UcdZend_View_Interface $view)
    {
     ...
     * @return string
     */
    protected function _recurseForm(UcdZend_Form $form, UcdZend_View_Interface $view)
    {
        $content = '';
        ...
        foreach ($form->getElementsAndSubFormsOrdered() as $subitem) {
            if ($subitem instanceof UcdZend_Form_Element && !$this->getOnlyCustomFormErrors()) {
            ...
            } else if ($subitem instanceof UcdZend_Form && !$this->ignoreSubForms()) {
