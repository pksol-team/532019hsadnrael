...
require_once 'UcdZend/Form/Decorator/FormElements.php';

/**
 * UcdZend_Form_Decorator_PrepareElements
 *
 ...
 */
class UcdZend_Form_Decorator_PrepareElements extends UcdZend_Form_Decorator_FormElements
{
    /**
    ...
    protected function _recursivelyPrepareForm(UcdZend_Form $form)
    {
