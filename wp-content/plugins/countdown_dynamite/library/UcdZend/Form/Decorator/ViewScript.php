...
/**
 * UcdZend_Form_Decorator_ViewScript
 *
 ...
 */
class UcdZend_Form_Decorator_ViewScript extends UcdZend_Form_Decorator_Abstract
{
    /**
     ...
     *
     * @param  string $script
     * @return UcdZend_Form_Decorator_ViewScript
     */
    ...
    public function render($content)
    {
        ...
        if (empty($viewScript)) {
            ...
            throw new UcdZend_Form_Exception('No view script registered with ViewScript decorator');
        }
