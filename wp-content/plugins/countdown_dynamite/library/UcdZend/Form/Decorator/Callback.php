...
/**
 * UcdZend_Form_Decorator_Callback
 *
 ...
 */
class UcdZend_Form_Decorator_Callback extends UcdZend_Form_Decorator_Abstract
{
    /**
     * Callback
     * @var string|array
     ...
     * @return UcdZend_Form_Decorator_Callback
    ...
    public function setCallback($callback)
    {
        if (!is_callable($callback)) {
            ...
            throw new UcdZend_Form_Exception('Invalid callback provided to callback decorator');
        }
