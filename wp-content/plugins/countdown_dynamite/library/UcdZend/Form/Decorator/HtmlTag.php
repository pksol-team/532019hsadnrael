...
/**
 * @see UcdZend_Form_Decorator_Abstract
 */
require_once 'UcdZend/Form/Decorator/Abstract.php';

/**
 * UcdZend_Form_Decorator_Element_HtmlTag
 *
 ...
 */
class UcdZend_Form_Decorator_HtmlTag extends UcdZend_Form_Decorator_Abstract
{
    /**
    ...
    public function normalizeTag($tag)
    {
        if (!isset($this->_tagFilter)) {
            ...
            require_once 'UcdZend/Filter/Alnum.php';
            require_once 'UcdZend/Filter/StringToLower.php';
            $this->_tagFilter = new UcdZend_Filter();
            $this->_tagFilter->addFilter(new UcdZend_Filter_Alnum())
                             ->addFilter(new UcdZend_Filter_StringToLower());
        }
     ...
     *
     * @param  string $tag
     * @return UcdZend_Form_Decorator_HtmlTag
     */
    ...
    protected function _getEncoding()
    {
        ...
        if (null === ($element = $this->getElement())) {
            ...
            $this->_encoding = 'UTF-8';
        } elseif (!$view instanceof UcdZend_View_Abstract
