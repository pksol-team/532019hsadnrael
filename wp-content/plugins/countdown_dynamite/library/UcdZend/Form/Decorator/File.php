...
/** UcdZend_Form_Decorator_Marker_File_Interface */
require_once 'UcdZend/Form/Decorator/Marker/File/Interface.php';

/** UcdZend_File_Transfer_Adapter_Http */
require_once 'UcdZend/File/Transfer/Adapter/Http.php';

/**
 * UcdZend_Form_Decorator_File
 *
 ...
 */
class UcdZend_Form_Decorator_File
    extends UcdZend_Form_Decorator_Abstract
    implements UcdZend_Form_Decorator_Marker_File_Interface
{
    /**
    ...
    public function render($content)
    {
        ...
        if (!$view instanceof UcdZend_View_Interface) {
            return $content;
        }
        ...
        if (UcdZend_File_Transfer_Adapter_Http::isApcAvailable()) {
            $markup[] = $view->formHidden(ini_get('apc.rfc1867_name'), uniqid(), array('id' => 'progress_key'));
        } else if (UcdZend_File_Transfer_Adapter_Http::isUploadProgressAvailable()) {
