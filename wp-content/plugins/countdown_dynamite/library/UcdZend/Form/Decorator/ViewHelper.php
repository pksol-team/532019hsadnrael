...
/**
 * UcdZend_Form_Decorator_ViewHelper
 *
 ...
 */
class UcdZend_Form_Decorator_ViewHelper extends UcdZend_Form_Decorator_Abstract
{
    /**
    ...
    protected $_buttonTypes = array(
        'UcdZend_Form_Element_Button',
        'UcdZend_Form_Element_Reset',
        'UcdZend_Form_Element_Submit',
    );
     ...
     *
     * @param  string $helper
     * @return UcdZend_Form_Decorator_Element_ViewHelper
     */
     ...
     * Get name
     *
     * If element is a UcdZend_Form_Element, will attempt to namespace it if the
     ...
     * @return string
     * @throws UcdZend_Form_Decorator_Exception if element or view are not registered
     */
    public function render($content)
    {
        ...
        if (null === $view) {
            ...
            throw new UcdZend_Form_Decorator_Exception('ViewHelper decorator cannot render without a registered view object');
        }
