...
/**
 * UcdZend_Form_Decorator_Description
 *
 * Accepts the options:
 ...
 */
class UcdZend_Form_Decorator_Description extends UcdZend_Form_Decorator_Abstract
{
    /**
     ...
     *
     * @param  string $tag
     * @return UcdZend_Form_Decorator_Description
     */
    ...
    public function render($content)
    {
        ...
        if (!empty($tag)) {
            ...
            $options['tag'] = $tag;
            $decorator = new UcdZend_Form_Decorator_HtmlTag($options);
