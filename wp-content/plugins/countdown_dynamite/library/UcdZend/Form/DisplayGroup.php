 ...
 */
class UcdZend_Form_DisplayGroup implements Iterator,Countable
{
    /**
     * Group attributes
     * @var array
     ...
     * @var UcdZend_Loader_PluginLoader
     */
    protected $_loader;
     ...
     *
     * @param  string $name
     * @param  UcdZend_Loader_PluginLoader $loader
     * @param  array|UcdZend_Config $options
     * @return void
     */
    public function __construct($name, UcdZend_Loader_PluginLoader $loader, $options = null)
    {
        $this->setName($name);
     ...
     *
     * @param  array $options
     * @return UcdZend_Form_DisplayGroup
     */
     ...
     *
     * @param  UcdZend_Form_Element $element
     * @return UcdZend_Form_DisplayGroup
     */
    public function addElement(UcdZend_Form_Element $element)
    {
     ...
     * @return UcdZend_Form_DisplayGroup
     * @throws UcdZend_Form_Exception if any element is not a UcdZend_Form_Element
     */
    public function addElements(array $elements)
    {
        foreach ($elements as $element) {
            if (!$element instanceof UcdZend_Form_Element) {
                require_once 'UcdZend/Form/Exception.php';
                throw new UcdZend_Form_Exception('elements passed via array to addElements() must be UcdZend_Form_Elements only');
            }
     ...
     * @return UcdZend_Form_DisplayGroup
     */
    public function setPluginLoader(UcdZend_Loader_PluginLoader $loader)
    {
        $this->_loader = $loader;
        return $this;
    }
    ...
    {
        if ((null === $translator) || ($translator instanceof UcdZend_Translate_Adapter)) {
