...
class UcdZend_File_Transfer
{
     ...
     * @throws UcdZend_File_Transfer_Exception
     */
    ...
    {
        if (UcdZend_Loader::isReadable('UcdZend/File/Transfer/Adapter/' . ucfirst($adapter). '.php')) {
            $adapter = 'UcdZend_File_Transfer_Adapter_' . ucfirst($adapter);
        }
        ...
        if (!$this->_adapter[$direction] instanceof UcdZend_File_Transfer_Adapter_Abstract) {
            require_once 'UcdZend/File/Transfer/Exception.php';
            throw new UcdZend_File_Transfer_Exception("Adapter " . $adapter . " does not extend UcdZend_File_Transfer_Adapter_Abstract");
        }
     ...
     * @return array|UcdZend_File_Transfer_Adapter
     */
    ...
    public function __call($method, array $options)
    {
        ...
        require_once 'UcdZend/File/Transfer/Exception.php';
        throw new UcdZend_File_Transfer_Exception("Unknown method '" . $method . "' called!");
    }
}
