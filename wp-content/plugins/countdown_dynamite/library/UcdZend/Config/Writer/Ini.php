 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Config_Writer_Ini extends UcdZend_Config_Writer_FileAbstract
{
    /**
     ...
     * @return UcdZend_Config_Writer_Ini
     */
    ...
    /**
     * Render a UcdZend_Config into a INI config string.
     *
     * @since 1.10
     * @return string
     */
     ...
     * @return void
     */
    protected function _addBranch(UcdZend_Config $config, $parents = array())
    {
        $iniString = '';
    ...
    protected function _prepareValue($value)
    {
        if (is_integer($value) || is_float($value)) {
            ...
            throw new UcdZend_Config_Exception('Value can not contain double quotes "');
        }
    }
     ...
     * @param  UcdZend_Config
     * @return UcdZend_Config
     */
    protected function _sortRootElements(UcdZend_Config $config)
    {
        ...
        return new UcdZend_Config($configArray);
    }
}
