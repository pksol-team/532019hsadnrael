 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_Alpha extends UcdZend_Validate_Abstract
{
     ...
     * @return UcdZend_Filter_Alpha Provides a fluent interface
     */
    ...
    public function isValid($value)
    {
        ...
        if (null === self::$_filter) {
            /**
             * @see UcdZend_Filter_Alpha
             */
            require_once 'UcdZend/Filter/Alpha.php';
            self::$_filter = new UcdZend_Filter_Alpha();
        }
