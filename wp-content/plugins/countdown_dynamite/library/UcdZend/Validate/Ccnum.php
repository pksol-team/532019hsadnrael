 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_Ccnum extends UcdZend_Validate_Abstract
{
    /**
    ...
    public function isValid($value)
    {
        ...
        if (null === self::$_filter) {
            /**
             * @see UcdZend_Filter_Digits
             */
            require_once 'UcdZend/Filter/Digits.php';
            self::$_filter = new UcdZend_Filter_Digits();
        }
