 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_InArray extends UcdZend_Validate_Abstract
{
     ...
     *
     * @param  array|UcdZend_Config $haystack
     * @return void
     */
    public function __construct($options)
    {
        if ($options instanceof UcdZend_Config) {
            ...
            throw new UcdZend_Validate_Exception('Array expected as parameter');
        } else {
            $count = func_num_args();
            $temp  = array();
            if ($count > 1) {
     ...
     * @return UcdZend_Validate_InArray Provides a fluent interface
     */
