 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_LessThan extends UcdZend_Validate_Abstract
{
     ...
     *
     * @param  mixed|UcdZend_Config $max
     * @return void
     */
    public function __construct($max)
    {
        if ($max instanceof UcdZend_Config) {
            $max = $max->toArray();
        }
        ...
        if (is_array($max)) {
            if (array_key_exists('max', $max)) {
                ...
                throw new UcdZend_Validate_Exception("Missing option 'max'");
            }
        }
     ...
     *
     * @param  mixed $max
     * @return UcdZend_Validate_LessThan Provides a fluent interface
     */
