...
/**
 * @see UcdZend_Validate_Barcode_AdapterInterface
 */
require_once 'UcdZend/Validate/Barcode/AdapterInterface.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class UcdZend_Validate_Barcode_AdapterAbstract
    implements UcdZend_Validate_Barcode_AdapterInterface
{
    /**
     ...
     *
     * @param  boolean $check
     * @return UcdZend_Validate_Barcode_AdapterAbstract
     */
