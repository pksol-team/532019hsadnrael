 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_EmailAddress extends UcdZend_Validate_Abstract
{
    ...
    protected $_options = array(
        ...
        'deep'     => false,
        'domain'   => true,
        'allow'    => UcdZend_Validate_Hostname::ALLOW_DNS,
        'hostname' => null
    );
     ...
     * 'hostname' => A hostname validator, see UcdZend_Validate_Hostname
     * 'allow'    => Options for the hostname validator, see UcdZend_Validate_Hostname::ALLOW_*
     * 'mx'       => If MX check should be enabled, boolean
     * 'deep'     => If a deep MX check should be done, boolean
     *
     * @param array|UcdZend_Config $options OPTIONAL
     * @return void
     */
     ...
     *
     * @param array $options
     * @return UcdZend_Validate_EmailAddress fluid interface
     */
    ...
    /**
     * @param UcdZend_Validate_Hostname $hostnameValidator OPTIONAL
     * @param int                    $allow             OPTIONAL
     * @return void
     */
    public function setHostnameValidator(UcdZend_Validate_Hostname $hostnameValidator = null, $allow = UcdZend_Validate_Hostname::ALLOW_DNS)
    {
        if (!$hostnameValidator) {
            $hostnameValidator = new UcdZend_Validate_Hostname($allow);
        }
    ...
    public function setValidateMx($mx)
    {
        if ((bool) $mx && !$this->validateMxSupported()) {
            ...
            throw new UcdZend_Validate_Exception('MX checking not available on this system');
        }
