 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_Identical extends UcdZend_Validate_Abstract
{
    /**
     * Error codes
     * @const string
    ...
    {
        if ($token instanceof UcdZend_Config) {
            $token = $token->toArray();
        }
     ...
     *
     * @param  mixed $token
     * @return UcdZend_Validate_Identical
     */
     ...
     *
     * @param UcdZend_Validate_Identical
     */
