 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_Iban extends UcdZend_Validate_Abstract
{
     ...
     *
     * @param  string|UcdZend_Config|UcdZend_Locale $locale OPTIONAL
     * @return void
     */
    ...
    public function setLocale($locale = null)
    {
        if ($locale !== false) {
            ...
            if (strlen($locale) < 4) {
                ...
                throw new UcdZend_Validate_Exception('Region must be given for IBAN validation');
            }
        }
    ...
    public function isValid($value)
    {
        ...
        if (empty($this->_locale)) {
            ...
            $region = new UcdZend_Locale($this->_locale);
