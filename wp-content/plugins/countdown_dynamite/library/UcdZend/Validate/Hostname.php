...
/**
 * @see UcdZend_Validate_Ip
 */
require_once 'UcdZend/Validate/Ip.php';

/**
 * Please note there are two standalone test scripts for testing IDN characters due to problems
 * with file encoding.
 *
 * The first is tests/UcdZend/Validate/HostnameTestStandalone.php which is designed to be run on
 * the command line.
 *
 * The second is tests/UcdZend/Validate/HostnameTestForm.php which is designed to be run via HTML
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_Hostname extends UcdZend_Validate_Abstract
{
    ...
    protected $_validIdns = array(
        ...
        'CN'  => 'Hostname/Cn.php',
        'COM' => 'UcdZend/Validate/Hostname/Com.php',
        ...
        'HK'  => 'UcdZend/Validate/Hostname/Cn.php',
        ...
        'JP'  => 'UcdZend/Validate/Hostname/Jp.php',
        ...
        'NET' => 'UcdZend/Validate/Hostname/Com.php',
        'NO'  => array(1 => '/^[\x{002d}0-9a-zàáä-éêñ-ôöøüčđńŋšŧž]{1,63}$/iu'),
        'NU'  => 'UcdZend/Validate/Hostname/Com.php',
        ...
        'TW'  => 'UcdZend/Validate/Hostname/Cn.php',
        ...
        '中国' => 'UcdZend/Validate/Hostname/Cn.php',
        '公司' => 'UcdZend/Validate/Hostname/Cn.php',
        '网络' => 'UcdZend/Validate/Hostname/Cn.php'
    );
     ...
     * @param UcdZend_Validate_Ip $ipValidator OPTIONAL
     * @return void
     ...
     *
     * @param array $options
     * @return UcdZend_Validate_Hostname
     */
     ...
     * @return void;
     */
    public function setIpValidator(UcdZend_Validate_Ip $ipValidator = null)
    {
        if ($ipValidator === null) {
            $ipValidator = new UcdZend_Validate_Ip();
        }
     ...
     *
     * @param  integer $allow
     * @return UcdZend_Validate_Hostname Provides a fluent interface
     */
     ...
     *
     * @param  string $value
     * @throws UcdZend_Validate_Exception if a fatal error occurs for validation process
     * @return boolean
     */
        ...
        if ((count($domainParts) > 1) && (strlen($value) >= 4) && (strlen($value) <= 254)) {
            ...
            do {
                ...
                if (preg_match('/([^.]{2,10})$/i', end($domainParts), $matches) ||
                     ...
                     * @see UcdZend_Validate_Hostname_Interface
                     */
