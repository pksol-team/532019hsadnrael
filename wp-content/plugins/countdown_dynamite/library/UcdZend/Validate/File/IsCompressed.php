...
/**
 * @see UcdZend_Validate_File_MimeType
 */
require_once 'UcdZend/Validate/File/MimeType.php';
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_File_IsCompressed extends UcdZend_Validate_File_MimeType
{
    /**
     ...
     *
     * @param  string|array|UcdZend_Config $compression
     * @return void
     */
    ...
    protected function _throw($file, $errorType)
    {
        ...
        switch($errorType) {
            case UcdZend_Validate_File_MimeType::FALSE_TYPE :
                $errorType = self::FALSE_TYPE;
                break;
            case UcdZend_Validate_File_MimeType::NOT_DETECTED :
                $errorType = self::NOT_DETECTED;
                break;
            case UcdZend_Validate_File_MimeType::NOT_READABLE :
