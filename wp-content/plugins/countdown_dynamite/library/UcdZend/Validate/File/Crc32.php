...
/**
 * @see UcdZend_Validate_File_Hash
 */
require_once 'UcdZend/Validate/File/Hash.php';
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_File_Crc32 extends UcdZend_Validate_File_Hash
{
    /**
     ...
     *
     * @param  string|array|UcdZend_Config $options
     * @return void
     */
