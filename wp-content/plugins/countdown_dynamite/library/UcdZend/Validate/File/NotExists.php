...
/**
 * @see UcdZend_Validate_File_Exists
 */
require_once 'UcdZend/Validate/File/Exists.php';
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_File_NotExists extends UcdZend_Validate_File_Exists
{
    /**
