 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_File_MimeType extends UcdZend_Validate_Abstract
{
    /**#@+
    ...
    {
        if ($mimetype instanceof UcdZend_Config) {
        ...
        if (null === $this->_magicfile) {
            if (!empty($_ENV['MAGIC'])) {
                ...
                foreach ($this->_magicFiles as $file) {
                    ...
                    } catch (UcdZend_Validate_Exception $e) {
     ...
     *
     * @param  string $file
     * @throws UcdZend_Validate_Exception When finfo can not read the magicfile
     * @return UcdZend_Validate_File_MimeType Provides fluid interface
     */
    public function setMagicFile($file)
    {
        if (empty($file)) {
            ...
            $this->_magicfile = null;
            require_once 'UcdZend/Validate/Exception.php';
            throw new UcdZend_Validate_Exception('Magicfile can not be set. There is no finfo extension installed');
        } else if (!is_readable($file)) {
            require_once 'UcdZend/Validate/Exception.php';
            throw new UcdZend_Validate_Exception('The given magicfile can not be read');
        } else {
            ...
            if (empty($this->_finfo)) {
                $this->_finfo = null;
                require_once 'UcdZend/Validate/Exception.php';
                throw new UcdZend_Validate_Exception('The given magicfile is not accepted by finfo');
            } else {
     ...
     * @return UcdZend_Validate_File_Extension Provides a fluent interface
     */
