...
/**
 * @see UcdZend_Validate_File_Size
 */
require_once 'UcdZend/Validate/File/Size.php';
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_File_FilesSize extends UcdZend_Validate_File_Size
{
    /**
     ...
     *
     * @param  integer|array|UcdZend_Config $options Options for this validator
     * @return void
     */
    ...
    public function isValid($value, $file = null)
    {
        ...
        foreach ($value as $files) {
            // Is file readable ?
            if (!UcdZend_Loader::isReadable($files)) {
