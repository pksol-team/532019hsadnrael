 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_File_Hash extends UcdZend_Validate_Abstract
{
    /**
     ...
     *
     * @param  string|array $options
     * @return UcdZend_Validate_File_Hash Provides a fluent interface
     */
    ...
    public function addHash($options)
    {
        if (is_string($options)) {
            ...
            require_once 'UcdZend/Validate/Exception.php';
            throw new UcdZend_Validate_Exception("False parameter given");
        }
        ...
        if (!in_array($algorithm, $known)) {
            require_once 'UcdZend/Validate/Exception.php';
            throw new UcdZend_Validate_Exception("Unknown algorithm '{$algorithm}'");
        }
