 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_CreditCard extends UcdZend_Validate_Abstract
{
    /**
     * Detected CCI list
     *
     ...
     * @return UcdZend_Validate_CreditCard Provides a fluid interface
     */
    ...
    public function setService($service)
    {
        if (!is_callable($service)) {
            ...
            throw new UcdZend_Validate_Exception('Invalid callback given');
        }
    ...
    public function isValid($value)
    {
        ...
        if (!empty($this->_service)) {
            try {
                require_once 'UcdZend/Validate/Callback.php';
                $callback = new UcdZend_Validate_Callback($this->_service);
