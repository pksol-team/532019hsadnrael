 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_Callback extends UcdZend_Validate_Abstract
{
    /**
     * Invalid callback
     */
    ...
    public function __construct($callback = null)
    {
        ...
        if (null === ($initializedCallack = $this->getCallback())) {
            ...
            throw new UcdZend_Validate_Exception('No callback registered');
        }
    }
     ...
     *
     * @param  string|array $callback
     * @return UcdZend_Validate_Callback Provides a fluent interface
     */
