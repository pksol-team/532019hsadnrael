 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_Barcode extends UcdZend_Validate_Abstract
{
     ...
     * Barcode adapter
     *
     * @var UcdZend_Validate_Barcode_BarcodeAdapter
     */
    protected $_adapter;
     ...
     *
     * @param  string|UcdZend_Config|
     *         UcdZend_Validate_Barcode_BarcodeAdapter $adapter Barcode adapter to use
     * @return void
     * @throws UcdZend_Validate_Exception
     */
    public function __construct($adapter)
    {
        if ($adapter instanceof UcdZend_Config) {
        ...
        if (is_array($adapter)) {
            ...
            if (array_key_exists('adapter', $adapter)) {
                ...
                throw new UcdZend_Validate_Exception("Missing option 'adapter'");
            }
        }
     ...
     *
     * @return UcdZend_Validate_Barcode_BarcodeAdapter
     */
     ...
     *
     * @param  string|UcdZend_Validate_Barcode $adapter Barcode adapter to use
    ...
    public function setAdapter($adapter, $options = null)
    {
        ...
        require_once 'UcdZend/Loader.php';
        if (UcdZend_Loader::isReadable('UcdZend/Validate/Barcode/' . $adapter. '.php')) {
            $adapter = 'UcdZend_Validate_Barcode_' . $adapter;
        }
        ...
        if (!$this->_adapter instanceof UcdZend_Validate_Barcode_AdapterInterface) {
            require_once 'UcdZend/Validate/Exception.php';
            throw new UcdZend_Validate_Exception(
                "Adapter " . $adapter . " does not implement UcdZend_Validate_Barcode_AdapterInterface"
            );
        }
     ...
     * @return UcdZend_Validate_Barcode
     */
