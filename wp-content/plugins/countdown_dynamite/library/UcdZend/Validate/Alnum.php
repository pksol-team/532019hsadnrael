 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_Alnum extends UcdZend_Validate_Abstract
{
     ...
     *
     * @param  boolean|UcdZend_Config $allowWhiteSpace
     * @return void
     */
    public function __construct($allowWhiteSpace = false)
    {
        if ($allowWhiteSpace instanceof UcdZend_Config) {
     ...
     * @return UcdZend_Filter_Alnum Provides a fluent interface
     */
    ...
    public function isValid($value)
    {
        ...
        if (null === self::$_filter) {
            /**
             * @see UcdZend_Filter_Alnum
             */
            require_once 'UcdZend/Filter/Alnum.php';
            self::$_filter = new UcdZend_Filter_Alnum();
        }
