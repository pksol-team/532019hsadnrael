 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_Date extends UcdZend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::INVALID        => "Invalid type given, value should be string, integer, array or UcdZend_Date",
     ...
     * Optional locale
     *
     * @var string|UcdZend_Locale|null
     */
    protected $_locale;
     ...
     *
     * @param  string|UcdZend_Config $options OPTIONAL
     * @return void
     */
    public function __construct($options = array())
    {
        ...
        if (!array_key_exists('locale', $options)) {
            ...
            if (UcdZend_Registry::isRegistered('UcdZend_Locale')) {
                $options['locale'] = UcdZend_Registry::get('UcdZend_Locale');
            }
        }
     ...
     *
     * @return string|UcdZend_Locale|null
     */
     ...
     * @return UcdZend_Validate_Date provides a fluent interface
     */
     ...
     * according to UcdZend_Date, see UcdZend_Date::isDate()
     *
     * @param  string|array|UcdZend_Date $value
     * @return boolean
     */
    public function isValid($value)
    {
        if (!is_string($value) && !is_int($value) && !is_float($value) &&
            !is_array($value) && !($value instanceof UcdZend_Date)) {
        ...
        if (($this->_format !== null) || ($this->_locale !== null) || is_array($value) ||
             $value instanceof UcdZend_Date) {
            require_once 'UcdZend/Date.php';
            if (!UcdZend_Date::isDate($value, $this->_format, $this->_locale)) {
    ...
    private function _checkFormat($value)
    {
        try {
            ...
            $parsed = UcdZend_Locale_Format::getDate($value, array(
            ...
            if (isset($parsed['year']) and ((strpos(strtoupper($this->_format), 'YY') !== false) and
                ...
                $parsed['year'] = UcdZend_Date::getFullYear($parsed['year']);
            }
        } catch (Exception $e) {
