 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_GreaterThan extends UcdZend_Validate_Abstract
{
     ...
     *
     * @param  mixed|UcdZend_Config $min
     * @return void
     */
    public function __construct($min)
    {
        if ($min instanceof UcdZend_Config) {
            $min = $min->toArray();
        }
        ...
        if (is_array($min)) {
            if (array_key_exists('min', $min)) {
                ...
                throw new UcdZend_Validate_Exception("Missing option 'min'");
            }
        }
     ...
     *
     * @param  mixed $min
     * @return UcdZend_Validate_GreaterThan Provides a fluent interface
     */
