 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_Between extends UcdZend_Validate_Abstract
{
    /**
    ...
    public function __construct($options)
    {
        ...
        if (!array_key_exists('min', $options) || !array_key_exists('max', $options)) {
            ...
            throw new UcdZend_Validate_Exception("Missing option. 'min' and 'max' has to be given");
        }
     ...
     *
     * @param  mixed $min
     * @return UcdZend_Validate_Between Provides a fluent interface
     */
