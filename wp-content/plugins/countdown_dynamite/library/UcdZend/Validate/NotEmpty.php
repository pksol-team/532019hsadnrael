 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Validate_NotEmpty extends UcdZend_Validate_Abstract
{
    const BOOLEAN       = 1;
    const INTEGER       = 2;
    const FLOAT         = 4;
    ...
    protected $_messageTemplates = array(
        ...
        // Workaround for GMQ-LZL-Q9GS: (contant usage crashes PHP)
     ...
     * @return UcdZend_Validate_NotEmpty
     */
    public function setType($type = null)
    {
        ...
        if (!is_int($type) || ($type < 0) || ($type > self::ALL)) {
            ...
            throw new UcdZend_Validate_Exception('Unknown type');
        }
