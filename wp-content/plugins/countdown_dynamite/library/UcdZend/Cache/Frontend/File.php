 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Cache_Frontend_File extends UcdZend_Cache_Core
{
     ...
     * - UcdZend_Cache_Frontend_File::MODE_AND or UcdZend_Cache_Frontend_File::MODE_OR
    ...
    public function __construct(array $options = array())
    {
        ...
        if (!isset($this->_specificOptions['master_files'])) {
            UcdZend_Cache::throwException('master_files option must be set');
        }
    }
    ...
    public function setMasterFiles(array $masterFiles)
    {
        ...
        foreach ($masterFiles as $masterFile) {
            ...
            if (!$this->_specificOptions['ignore_missing_master_files'] && !$mtime) {
                UcdZend_Cache::throwException('Unable to read master_file : ' . $masterFile);
            }
