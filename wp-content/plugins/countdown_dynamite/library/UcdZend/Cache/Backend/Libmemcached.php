 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class UcdZend_Cache_Backend_Libmemcached extends UcdZend_Cache_Backend implements UcdZend_Cache_Backend_ExtendedInterface
{
    /**
     ...
     * Log message
     */
    const TAGS_UNSUPPORTED_BY_CLEAN_OF_LIBMEMCACHED_BACKEND = 'UcdZend_Cache_Backend_Libmemcached::clean() : tags are unsupported by the Libmemcached backend';
    const TAGS_UNSUPPORTED_BY_SAVE_OF_LIBMEMCACHED_BACKEND =  'UcdZend_Cache_Backend_Libmemcached::save() : tags are unsupported by the Libmemcached backend';
    ...
    public function __construct(array $options = array())
    {
        if (!extension_loaded('memcached')) {
            UcdZend_Cache::throwException('The memcached extension must be loaded for using this backend !');
        }
    ...
    public function clean($mode = UcdZend_Cache::CLEANING_MODE_ALL, $tags = array())
    {
        switch ($mode) {
            ...
            case UcdZend_Cache::CLEANING_MODE_OLD:
                $this->_log("UcdZend_Cache_Backend_Libmemcached::clean() : CLEANING_MODE_OLD is unsupported by the Libmemcached backend");
                break;
    ...
    {
        $this->_log("UcdZend_Cache_Backend_Libmemcached::save() : getting the list of cache ids is unsupported by the Libmemcached backend");
        return array();
    }
    ...
    public function getFillingPercentage()
    {
        ...
        if ($memSize === null || $memUsed === null) {
            UcdZend_Cache::throwException('Can\'t get filling percentage');
        }
