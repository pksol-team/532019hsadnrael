...
$cfg['blowfish_secret']					= '=Rk2zVNkU.c0Z=)SN^!CI9F0KLmBhoNL' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
$cfg['DefaultLang']						= 'en';		// 'en'
$cfg['Servers'][$i]['only_db']			= array('braniffi_wordpre') ;    //i.e. array('db1', 'db2') Show only listed databases
$cfg['PmaAbsoluteUri'] 					= '/cl/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_OuXoYL0SHeUR9qxF4g58aJP/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
